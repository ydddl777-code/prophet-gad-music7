...
const APPS = [
  {
    id: 'music',
    name: 'Prophet Gad Music',
    tagline: '600+ Prophetic Tracks',
    description: 'The full prophetic music catalog — oracles set to rhythm. Bachata, Gospel, Reggae, Kompa and more. Stream previews and purchase full downloads. The sound of the last-day warning.',
    url: 'https://prophetgadmusic.com',
    icon: '🎵',
  ...
  },
  {
    ...
    url: 'https://clearsignalapp.ai',
    icon: '🔍',
    color: 'border-blue-700/50',
    labelColor: 'text-blue-400',
    cta: 'Visit Clear Signal',
  },
  {
    id: 'threshingfloor',
    name: 'The Threshing Floor',
    tagline: 'Bible Doctrinal Debate Arena',
    description: 'A Bible doctrinal debate arena. Video, music, and narration. You think there\'s no God? Bring your argument. Prophet Gad takes on all challengers from the Word of the God of Israel — chapter and verse, iron sharpening iron.',
    url: 'https://prophetgadspeaks.com',
    icon: '⚔️',
